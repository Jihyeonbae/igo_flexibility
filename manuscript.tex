...
The panel structure is retained for two reasons. First, it accommodates variation in membership composition over time. Many IGOs evolve after their founding through new countries' accession, democratization of existing members, or exit, which shifts the average regime type of the organization without a formal rule change. Second, year fixed effects absorb global time trends that may confound the cross-sectional relationship between regime composition and institutional design. It bears noting, however, that constitutional pooling rules are largely stable within IGOs over the observation period, consistent with the institutional stickiness characteristic of founding documents. As a result, identification rests primarily on cross-sectional variation across IGOs rather than within-IGO changes over time. To confirm that the main finding is not an artifact of the linear model's assumptions, I supplement the panel estimates with Tobit models that account for the bounded distribution of the dependent variable, and replicate the analysis across three alternative operationalizations of IGO-level democracy. Results are consistent across all specifications.
