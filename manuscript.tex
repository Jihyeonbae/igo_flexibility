...
Figure~\ref{fig:coef} presents coefficient estimates from a linear panel model examining the relationship between the average polyarchy score of an IGO's member states and constitutional pooling. Polyarchy is negatively associated with constitutional pooling and statistically significant at $95\%$. A one-unit increase in the average polyarchy score is associated with a 0.312-point decrease in constitutional pooling, meaning that less democratic IGOs adopt significantly more flexible amendment procedures. This result is robust across alternative operationalizations of regime composition, including the percentage of democratic members, median, and the liberal democracy index, as shown in \ref{app:alterantive_rob}.
